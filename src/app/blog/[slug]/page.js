  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">     
        <div className="prose lg:prose-xl text-gray-800" dangerouslySetInnerHTML={{ __html: post.content }} />
      </article>
      <section className="max-w-3xl mx-auto px-4 mb-12">     
        <div className="bg-blue-900 text-white rounded-2xl p-8 text-center">
          ...
          <Link href="/imoveis" className="bg-white text-blue-900 font-bold px-8 py-3 rounded-xl inline-block">
            Ver Imóveis
          </Link>
        </div>
      </section>
